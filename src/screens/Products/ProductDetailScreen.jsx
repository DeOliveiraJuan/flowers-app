  ...
  return (
    <div className='container'>
        ...
        <div className='description-container d-flex flex-column justify-content-between align-items-center m-5'>
            ...
            <button type="submit" className="btn btn-cart-detail d-flex btn-block justify-content-between align-items-center mb-4"><p className='m-0 p-0'>Agregar al carrito</p>   

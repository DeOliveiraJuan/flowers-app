...
const ProductCard = ({ product }) => {
  const { addToCart } = useContext(ShoppingCartContext)
    ...
    return (
      <div className="card rounded-0 border-0 mx-2 my-2">
        <div className="card-body p-0" style={{width: 250}} >
        ...
        <button onClick={() => addToCart(product.id)} type="submit" className="btn btn-cart btn-block align-self-end mt-0 mb-2">

...
function NavBar() {
    ...
    <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-flower1 ml-4" viewBox="0 0 16 16">
        ...
        <div className="btn-group">
              ...
              <div className="dropdown-menu dropdown-menu-right">
                <Link to='/login' className='dropdown-item'>Producto 1</Link>
                <Link to='/signup' className='dropdown-item'>Producto 2</Link>
              </div>
            </div>
        <div className="btn-group">
